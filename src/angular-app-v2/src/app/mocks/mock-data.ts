...
export const mockLookupTables: LookupTable[] = [
  ...
  // ── Truck Mate (McLeod v22) cross-reference tables ─────────────────
  // Keyed by tmsName so the Mapping XREF dialog can resolve them for
  // any deployment whose customer.tmsName === 'mcleod-v22'.
  {
    id: 'lkup-mcleod-v22-status',
    tmsSystemId: 'mcleod-v22',
    fieldName: 'loadStatus',
    name: 'McLeod v22 Load Status Codes',
    description: 'Translates McLeod v22 dispatch status codes to platform status values.',
  ...
  {
    id: 'lkup-mcleod-v22-equipment',
    tmsSystemId: 'mcleod-v22',
    fieldName: 'equipmentType',
    name: 'McLeod v22 Equipment Type Codes',
    description: 'Single-letter equipment codes used by McLeod v22.',
    mappings: JSON.stringify({
      V: 'Van',
      R: 'Reefer',
      F: 'Flatbed',
  ...
  {
    id: 'lkup-mcleod-v22-stoptypes',
    tmsSystemId: 'mcleod-v22',
    fieldName: 'stopType',
    name: 'McLeod v22 Stop Type Codes',
    description: 'Pickup / delivery / intermediate stop categorization.',
    mappings: JSON.stringify({
      PU: 'Pickup',
      DL: 'Delivery',
      DP: 'Dropoff',
