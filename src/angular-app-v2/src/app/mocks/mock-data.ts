...
export const mockTmsSystems: TmsSystem[] = [
  ...
  },
  {
    ...
    displayName: 'McLeod v22 — WorkflowAI Import Documents',
    description: 'McLeod LoadMaster v22 connector purposed for WorkflowAI document import',
    version: '22',
    isActive: true,
    applicationId: 'app-workflowai',
  ...
  },
  {
    ...
    displayName: 'SAP S/4 HANA — WorkflowAI Import Documents',
    description: 'SAP S/4 HANA connector purposed for WorkflowAI document import',
    version: '2023',
    isActive: true,
    applicationId: 'app-workflowai',
    capabilityId: 'cap-wfai-import-docs',
