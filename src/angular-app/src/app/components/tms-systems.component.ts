      ...
      <div *ngIf="showCreateForm" class="form-container">
        ...
        <form (ngSubmit)="createSystem()">
          ...
          <div class="form-group">
            ...
            <input type="text" [(ngModel)]="newSystem.displayName" name="displayName" required>
          </div>
          <div class="form-group">
            <label>Description:</label>
            <textarea [(ngModel)]="newSystem.description" name="description"></textarea>
          </div>
          <div class="form-group">
            <label>Version:</label>
            <input type="text" [(ngModel)]="newSystem.version" name="version">
          </div>
