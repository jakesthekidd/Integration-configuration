...
describe('TmsSystemsComponent', () => {
  ...
  const mockSystems: import('../../models/tms-system.model').TmsSystem[] = [
    { id: '1', name: 'sys1', displayName: 'System 1', description: 'desc', version: '1.0', isActive: true, createdAt: new Date('2024-01-01'), updatedAt: new Date('2024-01-01') },
  ];
  ...
  beforeEach(async () => {
    apiServiceSpy = jasmine.createSpyObj('ApiService', [
      'getTmsSystems', 'createTmsSystem', 'deleteTmsSystem'
    ]);
